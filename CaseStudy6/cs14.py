...
class Lecture14Scene(PrimeScene, ThreeDScene):
    def construct(self):
        ...
        axes_defaults = {"color": dark_blue, "include_numbers": False}
        ...
        grid2 = NumberPlane(
            ...
            axis_config={"stroke_color": dark_blue, "stroke_width": 0},
            x_range=(-3, 3, 1),
            y_range=(-3, 3, 1),
            shade_in_3d=True,
        ).scale(unit_length)
        ...
        grid = NumberPlane(
            ...
            axis_config={"stroke_color": dark_blue, "stroke_width": 2},
            x_range=(-5, 5, 1),
            y_range=(-3, 3, 1),
            shade_in_3d=True,
        ).scale(unit_length)
        ...
        x0_label3d = (
            ...
            .next_to(x0.get_center(), IN, buff=0.38)
        ...
        c_label = (
            MathTex(r"\mathbf{c}", color=ManimColor("#fcc13f"), shade_in_3d=True)
            .next_to(
                c.get_center(),
                OUT,
            )
        ...
        eq1 = MathTex(
            r"V_{\text{cube}} = |\mathbf{a}\cdot (\mathbf{b}\times \mathbf{c})| = |\operatorname{det}([\mathbf{a} \ \mathbf{b} \ \mathbf{c}])|",
            color=dark_blue,
            font_size=40,
        )[0]
        ...
        Jc_label = (
            MathTex(r"J\mathbf{c}", color=ManimColor("#fcc13f"), shade_in_3d=True)[0]
        ...
        Jc_label_2d = MathTex(r"J\mathbf{c}", color=yellow, font_size=48)[0].shift(
            UNIT * RIGHT
        )
        ...
        self.play(
            ReplacementTransform(Ja_label_2d, eq4[6:8]),
            ReplacementTransform(Jb_label_2d, eq4[10:12]),
            ReplacementTransform(Jc_label_2d, eq4[13:15]),
            GrowFromCenter(eq4[5]),
            GrowFromCenter(eq4[8:10]),
            GrowFromCenter(eq4[12]),
            GrowFromCenter(eq4[15:]),
            Write(eq4[:5]),
        )
        self.wait(1)
        ...
        eq9 = MathTex(
            r"=|\operatorname{det}(J)|\,V_{\text{cube}}", color=dark_blue, font_size=48
        )[0]
