...
class Lecture10Scene(PrimeScene):
    def construct(self):
        ...
        #column properties
        self.play(LaggedStart(Wiggle(VGroup(eq0[5], eq0[7], eq0[10])), Wiggle(VGroup(eq0[6], eq0[8:10], eq0[11])), lag_ratio=0.3))
        self.wait(1)
        self.play(LaggedStart(Wiggle(VGroup(eq0[22], eq0[28], eq0[34])), Wiggle(VGroup(eq0[23:28], eq0[29:34], eq0[35])), lag_ratio=0.5))
        self.wait(1)
        ...
        eq1 = MathTex(
            ...
            color=dark_blue, font_size=36)[0]
        ...
        self.play(LaggedStart(ReplacementTransform(eq0[2:15].copy(), eq1[37:50]), ReplacementTransform(eq0[18:].copy(), eq2[37:59]), lag_ratio=0.5))
        ...
        self.play(LaggedStart(ShrinkToCenter(eq1[9:51]), ShrinkToCenter(eq2[9:60]), eq0.animate.shift(4*UNIT*UP),
                              ReplacementTransform(eq1[:9], eq3[:9]), ReplacementTransform(eq1[51:], eq3[9:9+len(eq1[51:])]),
                              GrowFromCenter(eq3[9+len(eq1[51:])]),
                  ReplacementTransform(eq2[:9], eq3[9+len(eq1[51:]) + 1:9+len(eq1[51:]) + 10]), ReplacementTransform(eq2[60:], eq3[9+len(eq1[51:]) + 10:]), lag_ratio=0.3))
        self.wait(1)
        ...
        self.play(eq3[13:23].animate.set_color(blue), eq3[33:43].animate.set_color(blue), eq3[53].animate.set_color(blue))
        self.wait(1)

        self.play(LaggedStart(ReplacementTransform(Group(*eq3[13:23].copy(), *eq3[33:43].copy(), *eq3[53].copy()), eq4[4:25]),
        ...
        self.play(eq3[23:33].animate.set_color(red), eq3[43:53].animate.set_color(red), eq3[54].animate.set_color(red))
        self.wait(1)

        self.play(LaggedStart(ReplacementTransform(Group(*eq3[23:33].copy(), *eq3[43:53].copy(), *eq3[54].copy()),
                                                   eq4[34:55]),
                              GrowFromCenter(eq4[30:34]),
                              GrowFromCenter(eq4[55:59]), lag_ratio=0.5))
        self.wait(1)
        ...
        self.play(ReplacementTransform(eq4[:34], eq5[:34]),
                  ReplacementTransform(eq4[54:], eq5[57:]),
                  )
        self.play(ReplacementTransform(eq4[34:39], eq5[39:44]),
                  ReplacementTransform(eq4[39], eq5[38]),
                  ReplacementTransform(eq4[40:44], eq5[34:38]),
                  )
        self.play(ReplacementTransform(eq4[44:49],eq5[51:56]),
        ...
        self.play(ReplacementTransform(eq5[34:44], eq6[16]),
        ...
        self.play(ReplacementTransform(eq6, eq7[:len(eq6)]),
                  GrowFromCenter(eq7[len(eq6):]))
        self.wait(1)
        ...
        self.play(ReplacementTransform(eq7[:len(eq6) + 1], eq8[:len(eq6) + 1]),
                  ReplacementTransform(eq7[len(eq6) + 1:], eq8[len(eq6) + 1:]))
        self.wait(1)

        self.play(FadeOut(eq8), eq3[13:23].animate.set_color(dark_blue), eq3[33:43].animate.set_color(dark_blue),
                  eq3[53].animate.set_color(dark_blue), eq3[23:33].animate.set_color(dark_blue), eq3[43:53].animate.set_color(dark_blue), eq3[54].animate.set_color(dark_blue))
        self.wait(1)
        ...
        self.wait(1)
        self.play(Group(*eq3[74:78], *eq3[94:98], eq3[114]).animate.set_color(dark_blue))
        self.wait(1)
        ...
        eq10 = MathTex(
            ...
            color=dark_blue, font_size=30)[0]
        ...
        self.play(LaggedStart(
            ReplacementTransform(Group(*eq3[78:94].copy(), *eq3[98:114].copy(), eq3[115].copy()), eq10[7:40]),
            GrowFromCenter(eq10[:7]),
            GrowFromCenter(eq10[40:47]),
            GrowFromCenter(eq10[47]),
            ReplacementTransform(Group(*eq3[78:94].copy(), *eq3[98:114].copy(), eq3[115].copy()), eq10[55:88]),
        ...
        self.play(LaggedStart(ShrinkToCenter(eq11[0]),
        ...
        self.play(LaggedStart(ReplacementTransform(eq12, eq13[:len(eq12)]), Write(eq13[len(eq12):]), lag_ratio=0.5))
        self.wait(1)
        ...
        self.play(ReplacementTransform(eq11b[:3], eq15[:3]),
        ...
        self.play(ReplacementTransform(eq15[:6], eq16[:6]),
        ...
        self.play(Group(*eq3[78:94], *eq3[98:114], eq3[115]).animate.set_color(dark_blue))

        self.play(eq3.animate.shift(3*UNIT*DOWN))
        self.wait(1)
        
        self.play(LaggedStart(Wiggle(Group(*eq3[13:23], *eq3[33:43], *eq3[53])), Wiggle(Group(*eq3[23:33], *eq3[43:53], *eq3[54])), lag_ratio=0.3))
        self.wait(1)

        self.play(LaggedStart(Wiggle(Group(*eq3[74:78], *eq3[94:98], eq3[114])), Wiggle(Group(*eq3[78:94], *eq3[98:114], eq3[115])), lag_ratio=0.6))
        self.wait()
