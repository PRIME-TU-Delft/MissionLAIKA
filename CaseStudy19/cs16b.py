...
class Plane(MovingCameraScene, PrimeScene):
    def construct(self):
        ...
        self.wait()
        self.play(GrowFromCenter(eq20a), GrowFromCenter(eq21a), Group(eq20, eq21).animate.shift(UNIT*UP))
        self.wait()
        ...
        self.play(ReplacementTransform(eq22[13:19].copy(), eq27a), Group(eq20, eq20a, eq21, eq21a, eq22).animate.shift(2*UNIT*UP))
        self.wait()
